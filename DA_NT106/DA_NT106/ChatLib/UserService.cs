...
namespace ChatLib
{
    public class UserService : IUserService
    {
        ...
        private void sendEmail(string to_send_email, string to_send_username)
        {
            ...
            string fromEmail = System.Environment.GetEnvironmentVariable("chatappemail");
            string fromEmailPassword = System.Environment.GetEnvironmentVariable("chatapppassword");
            ...
            try
            {
                ...
                mail.Subject = "Hey " + to_send_username + " - ChatApp";
